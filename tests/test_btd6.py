...
async def test_valid_bosses_url():
    ...
    bosses_url = await _btd6_url_factory("bosses", bossID="some_boss_id", type="standard", teamSize="1")
    assert bosses_url == "https://data.ninjakiwi.com/btd6/bosses/some_boss_id/leaderboard/standard/1"


@pytest.mark.asyncio
async def test_invalid_bosses_url_invalid_bossID():
    """Test for invalid bosses URL due to invalid bossID."""
    invalid_bosses_url = await _btd6_url_factory("bosses", bossID="!@#invalid_boss_id", type="standard", teamSize="1")
...
async def test_invalid_bosses_url_invalid_type():
    ...
    invalid_bosses_url = await _btd6_url_factory("bosses", bossID="some_boss_id", type="invalid_type", teamSize="1")
    assert invalid_bosses_url is None
...
async def test_invalid_challenges_url_invalid_filter():
    ...
    invalid_challenges_url = await _btd6_url_factory("challenges", challengeFilter="invalid_filter")
...
async def test_valid_odyssey_url():
    ...
    odyssey_url = await _btd6_url_factory("odyssey", odysseyID="some_odyssey_id", difficulty="hard")
...
async def test_invalid_odyssey_url_invalid_difficulty():
    ...
    invalid_odyssey_url = await _btd6_url_factory("odyssey", odysseyID="some_odyssey_id", difficulty="invalid_difficulty")
...
async def test_valid_odyssey_url_with_maps():
    ...
    odyssey_url_with_maps = await _btd6_url_factory("odyssey", odysseyID="some_odyssey_id", difficulty="medium", maps=["map1", "map2"])
    assert odyssey_url_with_maps == "https://data.ninjakiwi.com/btd6/odyssey/some_odyssey_id/medium/maps"


@pytest.mark.asyncio
async def test_valid_users_url():
    """Test for valid users URL with userID."""
    users_url = await _btd6_url_factory("users", userID="some_user_id")
    assert users_url == "https://data.ninjakiwi.com/btd6/users/some_user_id"
